    ...
    m_levelResourcesLoaded(false)
{
    m_gameHud = ref new GameHud(
        deviceResources,
        "C++/CX Windows platform template",
        "DirectX first-person simulation"
    );
...
task<void> GameRenderer::CreateGameDeviceResourcesAsync(_In_ FPSim^ game)
{
